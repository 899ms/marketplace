  ...
  return (
    <div className='shadow-sm mx-auto max-w-2xl rounded-xl border border-stroke-soft-200 bg-bg-white-0'>
      ...
      <div className='flex items-center justify-between border-b border-stroke-soft-200 p-4'>
        <div>
          <h2 className='font-semibold text-[#0E121B] text-[16px]'>Post Service</h2>
          <p className='text-[12px] text-[#525866]'>Price and Details</p>
        </div>
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
          ...
          <div className='flex flex-col gap-1'>
            <Label.Root className='text-[14px] font-medium text-[#0E121B]'>
              Lead Time <span className='text-[#525866] text-[14px] whitespace-nowrap'> {"  (days)"}</span>
            </Label.Root>
            <Input.Root>
              <Input.Wrapper>
                <Input.Input
