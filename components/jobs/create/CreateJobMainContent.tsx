      ...
      >
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              <Accordion.Trigger className='!p-4 !mx-0 group/trigger flex w-full items-center justify-between text-left hover:bg-bg-weak-50' onClick={() => setActiveStep(stepNumber)}>
                {' '}
                {/* Added group */}
