            ...
            <div className='grid grid-cols-3 gap-4'>
              {[...Array(9)].map((_, i) => {
                const mockServiceData = {
                  id: `service-${i}`,
                  title: `Music Production Service ${i + 1}`,
                  description: `Professional music production service for artists looking to create high-quality tracks. We specialize in a variety of genres.`,
                  price: 50 + Math.floor(Math.random() * 200),
                  seller_id: `seller-${i}`,
                  seller_name: `Studio ${i + 1}`,
                  audio_url: null,
                  lead_time: 7,
                  currency: 'USD',
                  ...
                  includes: ['Revisions', '24/7 Support', 'Source Files'],
                  additional_services: [
                    {
                      name: 'Rush Delivery',
                      price: 50
                ...
                return <ServiceCard key={i} service={mockServiceData} />;
              })}
            </div>
          )}
          {activeTab === 'Project' && (
